...
class BirdSortGame:
    ...
    def executar_algoritmo(self):
        ...
        solver = Algoritmo()
        solucao = solver.resolver_com_a_estrela(tabuleiro_copia) # Inserir qual dos algoritmos deseja que a interface use para resolver automaticamente (Algoritmos presentes na classe "Algoritmo" no arquivo "algorithm.py")
